...
export default function WelcomePage({navigation}) {
  ...
  const handleSubmit = () => {
    if (isValid)
      navigation.navigate('WishHome_Revenu')
  ...
  return (
    <View style={container}>
      ...
      <View style={{padding: 20, height: '100%', justifyContent: "center"}}>
        ...
        <Title size="0" properties={{marginTop: 25, lineHeight: 50, width: "80%"}} title={`Veuillez saisir votre budget (hors frais de notaire)`}></Title>

        
        <TouchableOpacity style={InputProperties.element}>
          <Text style={InputProperties.label}>Veuillez saisir votre budget (hors frais de notaire)</Text>
