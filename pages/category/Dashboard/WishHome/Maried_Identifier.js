...
export default function WelcomePage({navigation}) {
  ...
  const setProfessionValue = (resp) => {
    ...
    wishHome.mariedProfession = resp;
  }
  ...
  return (
    <View style={container}>
      ...
      <View style={{padding: 20, height: '100%', justifyContent: "center"}}>
        ...
        <Title size="0" properties={{marginTop: 25, lineHeight: 50, width: "80%"}} title={`Veuillez saisir la Profession de votre fiancé(e)`}></Title>

        
        <TouchableOpacity style={InputProperties.element}>
          <Text style={InputProperties.label}>Veuillez saisir la Profession de votre fiancé(e)</Text>
