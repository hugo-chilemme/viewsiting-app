  ...
  return (
    <View style={container}>
      ...
      <View style={{padding: 20, height: '100%', justifyContent: "center"}}>
        ...
        <Title size="0" properties={{marginTop: 25, lineHeight: 50, width: "80%"}} title={`Quelle est votre situation familiale ?`}></Title>
        <View style={SelectorProperties.element}>
            <TouchableOpacity 
            style={selectedAnswer === "marié" ? SelectorProperties.buttonActive : buttonStyle} 
            onPress={() => {setResponse(true), setSelectedAnswer("marié"), setButtonStyle(SelectorProperties.buttonActive), setButtonStyle2(SelectorProperties.button)}}
            >
            <Text style={SelectorProperties.buttonText}>Je suis marié</Text>
            </TouchableOpacity>
            <TouchableOpacity 
            style={selectedAnswer === "divorcé/veuf" ? SelectorProperties.buttonActive : buttonStyle2} 
            onPress={() => {setResponse(false), setSelectedAnswer("divorcé/veuf"), setButtonStyle2(SelectorProperties.buttonActive), setButtonStyle(SelectorProperties.button)}}
            >
            <Text style={SelectorProperties.buttonText}>Je suis divorcé, ou veuf</Text>
            </TouchableOpacity>
        </View>
      </View>
